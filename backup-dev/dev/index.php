...
<head>
    ...
    <meta name="description" content="Des espaces adaptés et conviviaux, un projet pédagogique de qualité, et une équipe professionnelles attentives aux besoins des enfants :
    Au pays des comptines est une micro-crèche de Beuvry-la-forêt.">
    ...
    <div class="content">
        ...
        <section class="InfoEstablishment boxContainer" id="InfoEstablishment">
            <div class="SliderAndContent">
                ...
                <div class="slider">
                    <div class="slides">
                        <input type="radio" name="radio-btn" id="radio1" onclick="">
                        <input type="radio" name="radio-btn" id="radio2">
                        <input type="radio" name="radio-btn" id="radio3">
                        <input type="radio" name="radio-btn" id="radio4">

                        <div class="slide first">
                            <img src="./media/slides/1slide.jpeg" alt="Vue Exterieur Crèche">
                        </div>
                        <div class="slide second">
                            <img src="./media/slides/2slide.jpg" alt="Vue Intérieur Crèche">
                        </div>
                        <div class="slide third">
                            <img src="./media/slides/3slide.jpg" alt="Vue Intérieur Crèche">
                        </div>
                        <div class="slide fourth">
                            <img src="./media/slides/4slide.jpg" alt="Vue Intérieur Crèche">
                        </div>
